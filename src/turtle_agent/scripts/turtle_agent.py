...
from tools import turtle as turtle_tools  # Use alias for compatibility
...
class TurtleAgent(ROSA):
    ...
    def __init__(self, streaming: bool = False, verbose: bool = True):
        ...
        super().__init__(
            ...
            tool_packages=[turtle_tools, navigation_tools],
        ...
        self.examples = [
            "Where can the robot go?", # Should trigger list_known_locations
            "Send the robot to the professor room.", # Should trigger navigate_to_named_location
            "Navigate to laboratory1.",
            "Go to the water point.",
            "Take the robot to lift 2.",
...
if __name__ == "__main__":
    rospy.init_node("rosa_robot_agent_docker", log_level=rospy.INFO)
    main()
